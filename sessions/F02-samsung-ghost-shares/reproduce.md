...
| 버그: 착오 배치 커밋 후 | 30,655,000 | 30.66 | UPDATE 999 커밋 성공, 유령주 50,000주 매도도 통과 |
| 해소 1: 트리거 롤백 후 | 970,000 | 0.97 | 같은 배치가 ERROR 후 ROLLBACK, 매도는 잔고 부족 거부 |
| 경쟁 R1: 잠금 없음, 다른 계좌 | 1,010,000 | 1.01 | 두 세션 모두 커밋, 불변식 깨짐 |
| 경쟁 R2: 잠금 없음, 같은 계좌 | 990,000 | 0.99 | 행 잠금이 직렬화, B 거부 |
| 경쟁 R3: advisory lock | 990,000 | 0.99 | B가 잠금 대기 후 검증에서 거부 |
| 경쟁 R4: SERIALIZABLE | 990,000 | 0.99 | B가 커밋 시점 직렬화 오류, 재시도 힌트 |
