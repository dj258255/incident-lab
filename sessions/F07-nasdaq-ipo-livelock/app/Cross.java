...
//           컷오프 창에 도착한 취소는 거부한다.
//
// 데드락이 아니라 라이브락이다. 블로킹된 스레드는 없고 두 스레드 모두 계속 일하는데
// 크로스만 확정되지 않는다.
...
public class Cross {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 기준선을 두 가지로 잰다. 라이브락 루프는 계산을 쉬지 않고 돌리므로 연속 실행 쪽이
        ...
        // 주문장이 커지면 계산 1회가 길어지고, 그만큼 라이브락 임계점도 위로 올라간다.
