...
| 상황 | 배치 크기 | 근거 |
|---|---|---|
| 갱신 컬럼에 보조 인덱스 **없음** | **4,000행** | 실측 경계 6,230행 |
| 갱신 컬럼에 보조 인덱스 **1개 이상** | **2,000행 이하** | 실측 경계가 2,907행(1개)·2,491행(2개)으로 내려감 |
...
전제는 **보정 배치가 한 파티션 안에서 끝나는 것**입니다. 여러 파티션을 건드리면
파티션마다 락을 잡아 데드락 가능성이 올라갑니다.
