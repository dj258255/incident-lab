...
```console
[09:52:35] subtransaction_buffers=256kB
none          서브TX=0       tps=101382.970773 지연=0.587ms SLRU(hit read)=0 0             SubtransSLRU대기=0/235
sub64         서브TX=64      tps=98382.573787  지연=0.599ms SLRU(hit read)=0 0             SubtransSLRU대기=0/271
sub10k        서브TX=10000   tps=95111.857133  지연=0.625ms SLRU(hit read)=7615598 6       SubtransSLRU대기=0/277
sub500k       서브TX=500000  tps=70048.999651  지연=0.875ms SLRU(hit read)=4357752 1256582 SubtransSLRU대기=419/884
[09:54:24] subtransaction_buffers=4MB
none-buf      서브TX=0       tps=101314.650914 지연=0.582ms SLRU(hit read)=0 0             SubtransSLRU대기=0/245
sub500k-buf   서브TX=500000  tps=97145.854249  지연=0.608ms SLRU(hit read)=7782136 0       SubtransSLRU대기=0/240
```

미스율은 `sub500k`에서 1,256,582 / (4,357,752 + 1,256,582) = 22.4%입니다. 버퍼를 4MB로 올린 조건에서는 조회 778만 건이 전부 적중하고 미스가 0입니다.
