...
`terminate` 모드, 정상 구독자 5, 초당 3,000틱, 힙 128MB. 조건마다 1회 실행입니다.

| 조건 | 재접속 | 느린 구독자 수신 | 정상 p95 | 정상 최대 | 총 수신 |
|---|---|---|---|---|---|
| 재접속 없음 | 0회 | 173,765B | 1ms | 14ms | 666,972 |
| 100ms 뒤 재접속 | 2회 | 511,120B | 1ms | 20ms | 666,798 |
| 1,000ms 뒤 재접속 | 6회 | 1,250,590B | 1ms | 16ms | 666,636 |

### 절단은 재접속에도 버틴다

정상 구독자의 p95 가 세 조건 모두 1ms 이고 총 수신도 0.05% 안에서 같습니다. 매번 절단이
