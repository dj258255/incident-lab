...
다만 절대값을 봐야 합니다. 플래닝 0.6ms 는 질의 하나입니다. 이 질의가 초당 5,000건 돈다면 플래닝만으로 코어 3개를 씁니다. **target 을 올려서 늘어나는 것이 아니라 원래 그만큼 듭니다.** 준비된 문장(prepared statement)이나 계획 캐시가 필요한 이유가 여기 있습니다.
