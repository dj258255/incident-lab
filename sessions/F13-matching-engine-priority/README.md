...
| 배경 부하 | 상주 컨테이너 11개(모니터링 스택과 백엔드 서비스), 측정 전후 load average 1.4~2.4 |
...
수치는 2 vCPU 호스트에서 잰 값입니다. 다른 실험을 함께 돌리지는 않았지만 상주 컨테이너 11개가 계속 떠 있었고 측정 전후 load average가 1.4에서 2.4였습니다. 절대 시간을 다른 세션이나 다른 장비와 비교할 수 없습니다.
